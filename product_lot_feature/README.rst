...
This module extends the funcionality of *Product Feature* and adds lot features.
The lot features are defined in the product template and populated on product lot.
...
Just install and you can mark a feature to be a lot feature. It will not be added to product variant, but to product lot, when a new lot is created.
